...
class SearchBar extends React.Component {
  ...
  render() {
    ...
    if (this.props.search_text.length === 0) {
      return (
        <div className={style.outerSearchBar} style={{ borderColor: this.state.search_border_color }}>
          <span>
            <span className={style.searchBar}>
              <span className={style.scopeImg}>
              ...
              <form onSubmit={this.submitSearch.bind(this)}>
                <input className={style.searchTextArea} type="text" id="searchTextArea" placeholder="Search reviews"
        ...
        <div className={style.outerSearchBar} style={{ borderColor: this.state.search_border_color }}>
          <span>
            <span className={style.searchBar}>
              ...
              <form className={style.inlineForm} onSubmit={this.submitSearch.bind(this)}>
                <input className={style.searchTextArea} type="text" id="searchTextArea" placeholder="Search reviews"
                  onClick={this.testOnFunction.bind(this)}
                  onChange={this.props.editSearchText}></input>
              </form>
              <button className={style.cancelSearchButton} onClick={this.props.clearSearchText}>
